...
BEGIN_MESSAGE_MAP(LFOPluginEditor, CAbstractVstEditor)
	...
	ON_WM_HSCROLL()
	ON_COMMAND(IDC_BUTTON1, OnPluginEditor)
	...
	ON_CBN_SELCHANGE(IDC_COMBO3, OnMidiCCChanged)
	ON_COMMAND(IDC_RADIO7, OnParameterChanged)
	ON_COMMAND(IDC_RADIO8, OnParameterChanged)
	ON_EN_UPDATE(IDC_EDIT1, OnParameterChanged)
	ON_MESSAGE(LFOPlugin::WM_PARAM_UDPATE, OnUpdateParam)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
