...
{	//TODO: make this hideous list a bit nicer, with a constructor or somthing.
	...
	DefineKeyCommand(kcSetVolumeVol, 1232, _T("Vol command - volume"));
	DefineKeyCommand(kcSetVolumePan, 1233, _T("Vol command - pan"));
	DefineKeyCommand(kcSetVolumeVolSlideUp, 1234, _T("Vol command - vol slide up"));
	DefineKeyCommand(kcSetVolumeVolSlideDown, 1235, _T("Vol command - vol slide down"));
	DefineKeyCommand(kcSetVolumeFineVolUp, 1236, _T("Vol command - vol fine slide up"));
	DefineKeyCommand(kcSetVolumeFineVolDown, 1237, _T("Vol command - vol fine slide down"));
	DefineKeyCommand(kcSetVolumeVibratoSpd, 1238, _T("Vol command - vibrato speed"));
	DefineKeyCommand(kcSetVolumeVibrato, 1239, _T("Vol command - vibrato"));
	DefineKeyCommand(kcSetVolumeXMPanLeft, 1240, _T("Vol command - XM pan left"));
	DefineKeyCommand(kcSetVolumeXMPanRight, 1241, _T("Vol command - XM pan right"));
	DefineKeyCommand(kcSetVolumePortamento, 1242, _T("Vol command - Portamento"));
	DefineKeyCommand(kcSetVolumeITPortaUp, 1243, _T("Vol command - Portamento Up"));
	DefineKeyCommand(kcSetVolumeITPortaDown, 1244, _T("Vol command - Portamento Down"));
	DefineKeyCommand(kcSetVolumeITUnused, 1245, _T("Vol command - Unused"), kcHidden, kcNoDummy);
	DefineKeyCommand(kcSetVolumeITOffset, 1246, _T("Vol command - Offset"));
	DefineKeyCommand(kcSetFXParam0, 1247, _T("FX Param digit 0"));
	DefineKeyCommand(kcSetFXParam1, 1248, _T("FX Param digit 1"));
	DefineKeyCommand(kcSetFXParam2, 1249, _T("FX Param digit 2"));
	DefineKeyCommand(kcSetFXParam3, 1250, _T("FX Param digit 3"));
	DefineKeyCommand(kcSetFXParam4, 1251, _T("FX Param digit 4"));
	DefineKeyCommand(kcSetFXParam5, 1252, _T("FX Param digit 5"));
	DefineKeyCommand(kcSetFXParam6, 1253, _T("FX Param digit 6"));
	DefineKeyCommand(kcSetFXParam7, 1254, _T("FX Param digit 7"));
	DefineKeyCommand(kcSetFXParam8, 1255, _T("FX Param digit 8"));
	DefineKeyCommand(kcSetFXParam9, 1256, _T("FX Param digit 9"));
	DefineKeyCommand(kcSetFXParamA, 1257, _T("FX Param digit A"));
	DefineKeyCommand(kcSetFXParamB, 1258, _T("FX Param digit B"));
	DefineKeyCommand(kcSetFXParamC, 1259, _T("FX Param digit C"));
	DefineKeyCommand(kcSetFXParamD, 1260, _T("FX Param digit D"));
	DefineKeyCommand(kcSetFXParamE, 1261, _T("FX Param digit E"));
	DefineKeyCommand(kcSetFXParamF, 1262, _T("FX Param digit F"));
	...
	DefineKeyCommand(kcSetFXmacroSlide, 1294, _T("FX midi macro slide"));
	DefineKeyCommand(kcSetFXdelaycut, 1295, _T("FX combined note delay and note cut"));
	...
	DefineKeyCommand(kcSetSpacing, 1317, _T("Set row jump on note entry"), kcVisible, kcDummy);
	...
	*/
	...
	DefineKeyCommand(kcFileSaveAsWave, 1351, _T("File/Export as Wave"));
	DefineKeyCommand(kcFileSaveAsMP3, 1352, _T("File/Export as MP3"));
	DefineKeyCommand(kcFileSaveMidi, 1353, _T("File/Export as MIDI"));
	DefineKeyCommand(kcFileImportMidiLib, 1354, _T("File/Import Midi Lib"));
	DefineKeyCommand(kcFileAddSoundBank, 1355, _T("File/Add Sound Bank"));
	DefineKeyCommand(kcStopSong, 1356, _T("Stop Song"));
	DefineKeyCommand(kcMidiRecord, 1357, _T("Toggle Midi Record"));
	DefineKeyCommand(kcEstimateSongLength, 1358, _T("Estimate Song Length"));
	...
	DefineKeyCommand(kcEditSelectAll, 1364, _T("SelectAll"));
	...
	*/
	...
	DefineKeyCommand(kcSampleLoad, 1673, _T("Load a Sample"));
	DefineKeyCommand(kcSampleSave, 1674, _T("Save Sample"));
	DefineKeyCommand(kcSampleNew, 1675, _T("New Sample"));
	DefineKeyCommand(kcSampleCtrlLoad, 1676, _T("Load a Sample"), kcHidden, kcNoDummy);
	DefineKeyCommand(kcSampleCtrlSave, 1677, _T("Save Sample"), kcHidden, kcNoDummy);
	DefineKeyCommand(kcSampleCtrlNew, 1678, _T("New Sample"), kcHidden, kcNoDummy);
	DefineKeyCommand(kcInstrumentLoad, 1679, _T("Load an instrument"), kcHidden, kcNoDummy);
	DefineKeyCommand(kcInstrumentSave, 1680, _T("Save instrument"), kcHidden, kcNoDummy);
	DefineKeyCommand(kcInstrumentNew, 1681, _T("New instrument"), kcHidden, kcNoDummy);
	DefineKeyCommand(kcInstrumentCtrlLoad, 1682, _T("Load an instrument"), kcHidden, kcNoDummy);
	DefineKeyCommand(kcInstrumentCtrlSave, 1683, _T("Save instrument"), kcHidden, kcNoDummy);
	DefineKeyCommand(kcInstrumentCtrlNew, 1684, _T("New instrument"), kcHidden, kcNoDummy);
	...
	DefineKeyCommand(kcNavigateDownBySpacingSelect, 1689, _T("kcNavigateDownBySpacingSelect"), kcHidden, kcNoDummy);
	DefineKeyCommand(kcNavigateUpBySpacingSelect, 1690, _T("kcNavigateUpBySpacingSelect"), kcHidden, kcNoDummy);
	...
	DefineKeyCommand(kcPatternOpenRandomizer, 1767, _T("Go to row/channel/..."), kcHidden, kcNoDummy); // while there's not randomizer yet, let's just disable it for now
	...
	DefineKeyCommand(kcShowPatternProperties, 1772, _T("Show pattern properties window"));
	DefineKeyCommand(kcShowMacroConfig, 1773, _T("Show macro configuration"));
	DefineKeyCommand(kcViewSongProperties, 1775, _T("Show song properties window"));
	DefineKeyCommand(kcChangeLoopStatus, 1776, _T("Toggle loop pattern"));
	DefineKeyCommand(kcFileExportCompat, 1777, _T("File/Export to standard IT/XM/S3M"));
	...
	DefineKeyCommand(kcInstrumentEnvelopePointMoveUp8, 1834, _T("Move envelope point up (big step)"));
	DefineKeyCommand(kcInstrumentEnvelopePointMoveDown8, 1835, _T("Move envelope point down (big step)"));
	DefineKeyCommand(kcPatternEditPCNotePlugin, 1836, _T("Edit plugin assigned to PC note"));
