...
//-----------------------
{
	...
	CVstPlugin::Dispatch(effMainsChanged, 0,0, nullptr, 0);
...
//---------------------
{
	...
	if (m_pMachineInterface)
	{
		...
		m_pMachineInterface = nullptr;
	}
	if (m_pDataInput)
	{
		delete m_pDataInput;
		m_pDataInput = nullptr;
	}
}
...
//-------------------------------------------------------------------------------
{
	...
	if ((!pBuzzMachine) || (!pBuzzInfo)) return nullptr;
