...
//-------------------------------------------------------------------------
{
	...
	m_rSndFile.m_bChannelMuteTogglePending[chnIndex] = (m_rSndFile.ChnSettings[chnIndex].dwFlags & CHN_MUTE) != 0;
}
...
//----------------------------------------------------
{
	for(CHANNELINDEX i = 0; i<m_rSndFile.m_nChannels; i++)
	{
		m_rSndFile.m_bChannelMuteTogglePending[i] = (m_rSndFile.ChnSettings[i].dwFlags & CHN_MUTE) != 0;
	}
}
