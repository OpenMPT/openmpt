 ...
 * Load_mod.cpp
 * ------------
 * Purpose: MOD / NST (ProTracker / NoiseTracker), M15 / STK (Ultimate Soundtracker / Soundtracker), ST26 (SoundTracker 2.6 / Ice Tracker) and ChipTracker module loader / saver
