...
build\tools\7zipold\7za.exe x -y -obuild\tools\7zipa "build\externals\7z2500-extra.7z" || goto error
build\tools\7zipa\7za.exe x -y -obuild\tools\7zip "build\externals\7z2500-x64.exe" || goto error
