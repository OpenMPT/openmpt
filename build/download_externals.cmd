...
build\tools\7zipr\7zr.exe x -y -obuild\tools\7zip "build\externals\7z2602-x64.exe" || goto error
...
"build\externals\innosetup-7.0.2-x64.exe" /PORTABLE=1 /CURRENTUSER /DIR="%CD%\build\tools\innosetup\{app}" /LOG="%CD%\build\tools\innosetup\setup.log" /SILENT || goto error
