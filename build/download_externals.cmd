...
build\tools\7zipold\7za.exe x -y -obuild\tools\7zipa "build\externals\7z2601-extra.7z" || goto error
build\tools\7zipa\7za.exe x -y -obuild\tools\7zip "build\externals\7z2601-x64.exe" || goto error
...
call build\scriptlib\unpack.cmd "build\tools\python3" "build\externals\python-3.14.6-embed-amd64.zip" "." || goto error
