...
CPPFLAGS += -D_WIN32_WINDOWS=0x0400 -D_WIN32_IE=0x0000
else ifeq ($(WINDOWS_VERSION),win95plus)
CPPFLAGS += -D_WIN32_WINDOWS=0x0400 -D_WIN32_IE=0x0100
else ifeq ($(WINDOWS_VERSION),win95osr1)
CPPFLAGS += -D_WIN32_WINDOWS=0x0400 -D_WIN32_IE=0x0200
else ifeq ($(WINDOWS_VERSION),win95osr2)
CPPFLAGS += -D_WIN32_WINDOWS=0x0400 -D_WIN32_IE=0x0300
else ifeq ($(WINDOWS_VERSION),win95osr21)
CPPFLAGS += -D_WIN32_WINDOWS=0x0401 -D_WIN32_IE=0x0300
else ifeq ($(WINDOWS_VERSION),win95c)
CPPFLAGS += -D_WIN32_WINDOWS=0x0403 -D_WIN32_IE=0x0400
else ifeq ($(WINDOWS_VERSION),win98)
CPPFLAGS += -D_WIN32_WINDOWS=0x0410 -D_WIN32_IE=0x0400
else ifeq ($(WINDOWS_VERSION),win98se)
CPPFLAGS += -D_WIN32_WINDOWS=0x0410 -D_WIN32_IE=0x0500
else ifeq ($(WINDOWS_VERSION),winme)
CPPFLAGS += -D_WIN32_WINDOWS=0x0490 -D_WIN32_IE=0x0500
