...
svn cp -m "tag libopenmpt-${NEWVER}" -r ${NEWREV} https://source.openmpt.org/svn/openmpt/branches/OpenMPT-1.31 https://source.openmpt.org/svn/openmpt/tags/libopenmpt-${NEWVER}
...
echo "ALL DONE."
echo "run './release-0.7.sh $NEWVER +r${TAGREV}' in a website checkout after buildbot has finished."
