...
mkdir -p bin/stage/asmjs128m
make CONFIG=emscripten                    EMSCRIPTEN_TARGET=asmjs128m VERBOSE=1 clean
make CONFIG=emscripten TEST=1 ONLY_TEST=1 EMSCRIPTEN_TARGET=asmjs128m VERBOSE=1
make CONFIG=emscripten TEST=1 ONLY_TEST=1 EMSCRIPTEN_TARGET=asmjs128m VERBOSE=1 check
make CONFIG=emscripten TEST=0             EMSCRIPTEN_TARGET=asmjs128m VERBOSE=1
cp bin/libopenmpt.js     bin/stage/asmjs128m/
cp bin/libopenmpt.js.mem bin/stage/asmjs128m/
make CONFIG=emscripten                    EMSCRIPTEN_TARGET=asmjs128m VERBOSE=1 clean

mkdir -p bin/stage/asmjs
make CONFIG=emscripten                    EMSCRIPTEN_TARGET=asmjs VERBOSE=1 clean
make CONFIG=emscripten TEST=1 ONLY_TEST=1 EMSCRIPTEN_TARGET=asmjs VERBOSE=1
make CONFIG=emscripten TEST=1 ONLY_TEST=1 EMSCRIPTEN_TARGET=asmjs VERBOSE=1 check
make CONFIG=emscripten TEST=0             EMSCRIPTEN_TARGET=asmjs VERBOSE=1
cp bin/libopenmpt.js     bin/stage/asmjs/
cp bin/libopenmpt.js.mem bin/stage/asmjs/
make CONFIG=emscripten                    EMSCRIPTEN_TARGET=asmjs VERBOSE=1 clean
