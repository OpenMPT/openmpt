...
copy /y ..\installer\OpenMPT-%OPENMPT_VERSION%-RETRO-Setup.update.json                          openmpt\pkg.win-retro\%OPENMPT_VERSION_MAJORMAJOR%.%OPENMPT_VERSION_MAJOR%\OpenMPT-%MPT_REVISION%-RETRO-Setup.update.json.jws.json
...
copy /y ..\installer\OpenMPT-%OPENMPT_VERSION%-RETRO-portable-x86.update.json                   openmpt\pkg.win-retro\%OPENMPT_VERSION_MAJORMAJOR%.%OPENMPT_VERSION_MAJOR%\OpenMPT-%MPT_REVISION%-RETRO-portable-x86.update.json.jws.json
...
copy /y ..\installer\OpenMPT-%OPENMPT_VERSION%-RETRO-portable-amd64.update.json                 openmpt\pkg.win-retro\%OPENMPT_VERSION_MAJORMAJOR%.%OPENMPT_VERSION_MAJOR%\OpenMPT-%MPT_REVISION%-RETRO-portable-amd64.update.json.jws.json
