...
del /f /q libopenmpt-win-r%GOT_REVISION%.7z
...
"C:\Program Files\7-Zip\7z.exe" a -t7z -mx=9 ..\libopenmpt-win-r%GOT_REVISION%.7z ^
 LICENSE.txt ^
 changelog.md ^
 ...
 || goto error
cd .. || goto error
"C:\Program Files\7-Zip\7z.exe" a -ttar libopenmpt-win.tar libopenmpt-win-r%GOT_REVISION%.7z || goto error
del /f /q libopenmpt-win-r%GOT_REVISION%.7z
cd .. || goto error
...
del /f /q libopenmpt-dev-vs2010-r%GOT_REVISION%.7z
...
"C:\Program Files\7-Zip\7z.exe" a -t7z -mx=9 ..\libopenmpt-dev-vs2010-r%GOT_REVISION%.7z ^
 LICENSE.txt ^
 changelog.md ^
 ...
 || goto error
cd .. || goto error
"C:\Program Files\7-Zip\7z.exe" a -ttar libopenmpt-dev-vs2010.tar libopenmpt-dev-vs2010-r%GOT_REVISION%.7z || goto error
del /f /q libopenmpt-dev-vs2010-r%GOT_REVISION%.7z
cd .. || goto error
