...
(openmpt_version, openmpt_version_short) =  get_version_number("bin/release/vs2015-static/x86-32-win7/mptrack.exe")
...
copy_binaries("bin/release/vs2015-static/x86-32-win7/", openmpt_zip_32bit_path)
print("Copying 32-bit legacy binaries...")
shutil.rmtree(openmpt_zip_32bitold_basepath, ignore_errors=True)
copy_binaries("bin/release/vs2015-static/x86-32-winxp/", openmpt_zip_32bitold_path)
print("Copying 64-bit binaries...")
shutil.rmtree(openmpt_zip_64bit_basepath, ignore_errors=True)
copy_binaries("bin/release/vs2015-static/x86-64-win7/", openmpt_zip_64bit_path)
print("Copying 64-bit legacy binaries...")
shutil.rmtree(openmpt_zip_64bitold_basepath, ignore_errors=True)
copy_binaries("bin/release/vs2015-static/x86-64-winxp64/", openmpt_zip_64bitold_path)
