...
copy /y ..\installer\OpenMPT-%OPENMPT_VERSION%-portable-arm-legacy.zip                    openmpt\pkg.win\%OPENMPT_VERSION_MAJORMAJOR%.%OPENMPT_VERSION_MAJOR%\OpenMPT-%MPT_REVISION%-portable-arm-legacy.zip
copy /y ..\installer\OpenMPT-%OPENMPT_VERSION%-portable-arm-legacy.zip.digests            openmpt\pkg.win\%OPENMPT_VERSION_MAJORMAJOR%.%OPENMPT_VERSION_MAJOR%\OpenMPT-%MPT_REVISION%-portable-arm-legacy.zip.digests
copy /y ..\installer\OpenMPT-%OPENMPT_VERSION%-portable-arm-legacy.update.json            openmpt\pkg.win\%OPENMPT_VERSION_MAJORMAJOR%.%OPENMPT_VERSION_MAJOR%\OpenMPT-%MPT_REVISION%-portable-arm-legacy.update.json
copy /y ..\installer\OpenMPT-%OPENMPT_VERSION%-portable-arm-legacy.update.json.jws.json   openmpt\pkg.win\%OPENMPT_VERSION_MAJORMAJOR%.%OPENMPT_VERSION_MAJOR%\OpenMPT-%MPT_REVISION%-portable-arm-legacy.update.json.jws.json
