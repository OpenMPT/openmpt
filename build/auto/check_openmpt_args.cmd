...
msbuild PluginBridge.sln /target:Build /p:RunCodeAnalysis=true /p:EnableCppCoreCheck=false /property:Configuration=%MPT_VS_CONF%;Platform=%MPT_VS_ARCH_OTHER%;XPDeprecationWarning=false /maxcpucount /verbosity:minimal || goto error
