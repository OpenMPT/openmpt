...
cd "build\%MPT_VS_WITHTARGET%" || goto error
 ...
 if "%MPT_VS_ARCH%" == "Win32" (
  ...
  msbuild foo_openmpt.sln /target:Build /property:Configuration=Release;Platform=%MPT_VS_ARCH%;XPDeprecationWarning=false /maxcpucount /verbosity:minimal || goto error
 )
