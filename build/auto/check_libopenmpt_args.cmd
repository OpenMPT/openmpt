...
cd "build\%MPT_VS_WITHTARGET%" || goto error
 ...
 if "%MPT_VS_ARCH%" == "Win32" (
  ...
  msbuild foo_openmpt.sln /target:Build /p:RunCodeAnalysis=true /p:EnableCppCoreCheck=false /property:Configuration=Release;Platform=%MPT_VS_ARCH% /maxcpucount /verbosity:minimal || goto error
 )
