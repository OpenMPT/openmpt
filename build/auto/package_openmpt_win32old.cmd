...
"C:\Program Files\7-Zip\7z.exe" a -t7z -mx=9 openmpt-win32old-%MPT_REVISION%.7z mptrack.exe OpenMPT_SoundTouch_f32.dll "MIDI Input Output.dll" PluginBridge32.exe PluginBridge64.exe LICENSE || goto error
