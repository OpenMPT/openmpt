...
MUPARSER_LIB_OBJECTS =  &
	...
	obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\muParser_lib_muParserComplex.obj &
...
MUPARSER_DLL_OBJECTS =  &
	...
	obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\muParser_dll_muParserComplex.obj &
...
EXAMPLE2_CFLAGS = $(____DEBUG) $(____DEBUG_3) $(____DEBUG_6) $(____DEBUG_8) &
	-i=..\include $(____SHARED_1) $(CPPFLAGS) $(CFLAGS)
EXAMPLE2_OBJECTS =  &
	obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\example2_example2.obj
...
all : .SYMBOLIC $(__muParser_lib___depname) $(__muParser_dll___depname) $(__example1___depname) $(__example2___depname)
...
..\lib\muparser$(DEBUG_BUILD_POSTFIX).dll :  $(MUPARSER_DLL_OBJECTS)
	...
	@%append obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\muParser_dll.lbc  $(____DEBUG_7) $(LDFLAGS)
...
..\samples\example1\example1.exe :  $(EXAMPLE1_OBJECTS) $(__muParser_lib___depname)
	...
	@%append obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\example1.lbc  $(____DEBUG_7) libpath ..\lib $(LDFLAGS)
...
..\samples\example2\example2.exe :  $(EXAMPLE2_OBJECTS) $(__muParser_lib___depname)
	@%create obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\example2.lbc
	@%append obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\example2.lbc option quiet
	@%append obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\example2.lbc name $^@
	@%append obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\example2.lbc option caseexact
	@%append obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\example2.lbc  $(____DEBUG_7) libpath ..\lib $(LDFLAGS)
	@for %i in ($(EXAMPLE2_OBJECTS)) do @%append obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\example2.lbc file %i
	@for %i in ( ..\lib\muparser$(DEBUG_BUILD_POSTFIX).lib) do @%append obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\example2.lbc library %i
	@%append obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\example2.lbc
	@for %i in () do @%append obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\example2.lbc option stack=%i
	wlink @obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\example2.lbc
!endif
!endif

lib : .SYMBOLIC $(__muParser_lib___depname) $(__muParser_dll___depname)

samples : .SYMBOLIC $(__example1___depname) $(__example2___depname)
...
obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\muParser_lib_muParserComplex.obj :  .AUTODEPEND ..\src\muParserComplex.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(MUPARSER_LIB_CXXFLAGS) $<
...
obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\muParser_dll_muParserComplex.obj :  .AUTODEPEND ..\src\muParserComplex.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(MUPARSER_DLL_CXXFLAGS) $<
...
obj\wat_$(SHAREDBUILDPOSTFIX)_$(DEBUGBUILDPOSTFIX)\example2_example2.obj :  .AUTODEPEND ..\samples\example2\example2.c
	$(CC) -bt=nt -zq -fo=$^@ $(EXAMPLE2_CFLAGS) $<
