...
LD_LIBRARY_PATH=$FUZZING_TEMPDIR/bin $AFL_PATH/afl-fuzz -x all_formats.dict -t $FUZZING_TIMEOUT $FUZZING_INPUT -o $FUZZING_FINDINGS_DIR -M fuzzer01 $FUZZING_TEMPDIR/bin/fuzz
