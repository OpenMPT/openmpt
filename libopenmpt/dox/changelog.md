...
### libopenmpt 0.4.53-pre

 *  [**Sec**] Possible out-of-bounds sample data read in a specific combination
    of reverse sample playback + offset past sample loop. (r25046).
 ...
 *  [**Sec**] Possible out-of-bounds sample data read in a specific combination
    of reverse sample playback + offset past sample loop. (r23715).
