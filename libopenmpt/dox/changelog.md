...
### libopenmpt 0.5.45-pre

### libopenmpt 0.5.44 (2026-08-19)

 *  [**Sec**] Possible heap out-of-bounds read when loading custom tunings from
    MPTM files (r25612, r25618).

### libopenmpt 0.5.43 (2026-08-15)
 ...
 *  [**Sec**] The security fix in libopenmpt 0.5.41 (r25045) was incomplete,
    causing a regression when playing short looped ("chip") samples (r25087).

 *  mpg123: Update to v1.33.4 (2025-12-20).

### libopenmpt 0.5.41 (2026-03-22)

 *  [**Sec**] Possible out-of-bounds sample data read in a specific combination
    of reverse sample playback + offset past sample loop. (r25045).
