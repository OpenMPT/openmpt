 ...
 *  [**Sec**] Possible heap out-of-bounds write when loading SymMOD files
    containing WAV IMA ADPCM samples (r25629). See also
 ...
 *  [**Sec**] Possible heap out-of-bounds read when loading custom tunings from
    MPTM files (r25611, r25617).

### libopenmpt 0.6.29 (2026-08-15)
...
### libopenmpt 0.6.28 (2026-03-24)

 *  [**Sec**] The security fix in libopenmpt 0.6.28 (r25044) was incomplete,
    causing a regression when playing short looped ("chip") samples (r25086).
 ...
 *  [**Sec**] Possible out-of-bounds sample data read in a specific combination
    of reverse sample playback + offset past sample loop. (r25044).
 ...
 *  [**Sec**] Potential division by 0 when seeking in the module with
    `seek.sync_samples` enabled (r21168).
...
### libopenmpt 0.6.12 (2023-09-09)

 *  [**Regression**] We no longer provide libopenmpt 0.6 binaries for
