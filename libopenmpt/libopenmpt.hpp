	...
	*/
	...
	/*!
	  ...
	  \remarks Currently supported ctl values are:
	           ...
	           - play.at_end: Chooses the behaviour when the end of song is reached. The song end is considered to be reached after the number of reptitions set by openmpt::module::set_repeat_count was played, so if the song is set to repeat infinitely, its end is never considered to be reached.
