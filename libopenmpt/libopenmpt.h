...
#define OPENMPT_MODULE_RENDER_MASTERGAIN_DB            1
...
#define OPENMPT_MODULE_RENDER_INTERPOLATION_MODE       6
#define OPENMPT_MODULE_RENDER_VOLUMERAMP_IN_SAMPLES    7
#define OPENMPT_MODULE_RENDER_VOLUMERAMP_OUT_SAMPLES   8

#define OPENMPT_MODULE_RENDER_INTERPOLATION_NEAREST           1
#define OPENMPT_MODULE_RENDER_INTERPOLATION_LINEAR            2
#define OPENMPT_MODULE_RENDER_INTERPOLATION_SPLINE            3
#define OPENMPT_MODULE_RENDER_INTERPOLATION_POLYPHASE         4
#define OPENMPT_MODULE_RENDER_INTERPOLATION_FIR_HANN          5
#define OPENMPT_MODULE_RENDER_INTERPOLATION_FIR_HAMMING       6
#define OPENMPT_MODULE_RENDER_INTERPOLATION_FIR_BLACKMANEXACT 7
#define OPENMPT_MODULE_RENDER_INTERPOLATION_FIR_BLACKMAN3T61  8
#define OPENMPT_MODULE_RENDER_INTERPOLATION_FIR_BLACKMAN3T67  9
#define OPENMPT_MODULE_RENDER_INTERPOLATION_FIR_BLACKMAN4T92  10
#define OPENMPT_MODULE_RENDER_INTERPOLATION_FIR_BLACKMAN4T74  11
#define OPENMPT_MODULE_RENDER_INTERPOLATION_FIR_KAISER4T      12
...
LIBOPENMPT_API size_t openmpt_module_read_quad(   openmpt_module * mod, int32_t samplerate, size_t count, int16_t * left, int16_t * right, int16_t * back_left, int16_t * back_right );
...
LIBOPENMPT_API size_t openmpt_module_read_float_quad(   openmpt_module * mod, int32_t samplerate, size_t count, float * left, float * right, float * back_left, float * back_right );
