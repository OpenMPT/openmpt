...
cppcheck-libopenmpt:
	...
	$(SILENT)$(CPPCHECK) -DCPPCHECK $(CPPCHECK_FLAGS) $(CPPCHECK_PLATFORM) --check-config --suppress=unmatchedSuppression $(LIBOPENMPT_CXX_SOURCES) $(LIBOPENMPT_C_SOURCES)
	$(SILENT)$(CPPCHECK) -DCPPCHECK $(CPPCHECK_FLAGS) $(CPPCHECK_PLATFORM) $(LIBOPENMPT_CXX_SOURCES) $(LIBOPENMPT_C_SOURCES)

.PHONY: cppcheck-libopenmpt-test
cppcheck-libopenmpt-test:
	$(INFO) [CPPCHECK] libopenmpt-test
	$(SILENT)$(CPPCHECK) -DCPPCHECK $(CPPCHECK_FLAGS) $(CPPCHECK_PLATFORM) -DLIBOPENMPT_BUILD_TEST --check-config --suppress=unmatchedSuppression $(LIBOPENMPTTEST_CXX_SOURCES) $(LIBOPENMPTTEST_C_SOURCES)
	$(SILENT)$(CPPCHECK) -DCPPCHECK $(CPPCHECK_FLAGS) $(CPPCHECK_PLATFORM) -DLIBOPENMPT_BUILD_TEST $(LIBOPENMPTTEST_CXX_SOURCES) $(LIBOPENMPTTEST_C_SOURCES)

.PHONY: cppcheck-openmpt123
cppcheck-openmpt123:
	$(INFO) [CPPCHECK] openmpt123
	$(SILENT)$(CPPCHECK) -DCPPCHECK $(CPPCHECK_FLAGS) $(CPPCHECK_PLATFORM) --check-config --suppress=unmatchedSuppression $(OPENMPT123_CXX_SOURCES)
	$(SILENT)$(CPPCHECK) -DCPPCHECK $(CPPCHECK_FLAGS) $(CPPCHECK_PLATFORM) $(OPENMPT123_CXX_SOURCES)
