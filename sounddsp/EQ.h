...
public:
	...
	void ProcessStereo(int *pbuffer, UINT nCount, CSoundFilePlayConfig *pConfig, DWORD SoundSetupFlags, DWORD SysInfoFlags);
	void ProcessMono(int *pbuffer, UINT nCount, CSoundFilePlayConfig *pConfig);
