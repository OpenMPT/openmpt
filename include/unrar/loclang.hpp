...
#define   MCHelpSwTN         L"\n  tn[m,c,a]<t>  Process files newer than <t> time"
#define   MCHelpSwTO         L"\n  to[m,c,a]<t>  Process files older than <t> time"
#define   MCHelpSwTA         L"\n  ta[m,c,a]<d>  Process files modified after <d> YYYYMMDDHHMMSS date"
#define   MCHelpSwTB         L"\n  tb[m,c,a]<d>  Process files modified before <d> YYYYMMDDHHMMSS date"
