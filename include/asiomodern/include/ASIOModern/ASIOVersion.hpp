...
#define ASIO_MODERNSDK_VERSION_MINOR 10
#define ASIO_MODERNSDK_VERSION_PATCH 8
...
#define ASIO_VERSION_NAMESPACE ASIO_VERSION_BUILD_NAMESPACE(ASIO_VERSION_MAJOR, ASIO_VERSION_MINOR, ASIO_VERSION_PATCH, ASIO_VERSION_BUILD)
...
struct VersionInfo {
	...
	template <typename Tostream> friend Tostream & operator << (Tostream & os, VersionInfo vi) {
		if ( vi.Build > 0 ) {
...
constexpr VersionInfo Version = { {ASIO_VERSION_MAJOR,ASIO_VERSION_MINOR,ASIO_VERSION_PATCH},ASIO_VERSION_BUILD };

constexpr VersionInfo ModernSDKVersion = { {ASIO_MODERNSDK_VERSION_MAJOR,ASIO_MODERNSDK_VERSION_MINOR,ASIO_MODERNSDK_VERSION_PATCH},ASIO_MODERNSDK_VERSION_BUILD };
