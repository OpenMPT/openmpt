...
constexpr inline TimeCodeFlags operator| ( TimeCodeFlags a, TimeCodeFlags b ) noexcept { return static_cast<TimeCodeFlags>( static_cast<std::underlying_type<TimeCodeFlags>::type>(a) | static_cast<std::underlying_type<TimeCodeFlags>::type>(b) ); }
constexpr inline TimeCodeFlags operator& ( TimeCodeFlags a, TimeCodeFlags b ) noexcept { return static_cast<TimeCodeFlags>( static_cast<std::underlying_type<TimeCodeFlags>::type>(a) & static_cast<std::underlying_type<TimeCodeFlags>::type>(b) ); }
constexpr inline TimeCodeFlags operator^ ( TimeCodeFlags a, TimeCodeFlags b ) noexcept { return static_cast<TimeCodeFlags>( static_cast<std::underlying_type<TimeCodeFlags>::type>(a) ^ static_cast<std::underlying_type<TimeCodeFlags>::type>(b) ); }
constexpr inline TimeCodeFlags operator~ ( TimeCodeFlags a ) noexcept { return static_cast<TimeCodeFlags>( ~static_cast<std::underlying_type<TimeCodeFlags>::type>(a) ); }
constexpr inline TimeCodeFlags & operator|= ( TimeCodeFlags & a, TimeCodeFlags b ) noexcept { return a = a | b; }
constexpr inline TimeCodeFlags & operator&= ( TimeCodeFlags & a, TimeCodeFlags b ) noexcept { return a = a & b; }
constexpr inline TimeCodeFlags & operator^= ( TimeCodeFlags & a, TimeCodeFlags b ) noexcept { return a = a ^ b; }
...
constexpr inline TimeInfoFlags operator| ( TimeInfoFlags a, TimeInfoFlags b ) noexcept { return static_cast<TimeInfoFlags>( static_cast<std::underlying_type<TimeInfoFlags>::type>(a) | static_cast<std::underlying_type<TimeInfoFlags>::type>(b) ); }
constexpr inline TimeInfoFlags operator& ( TimeInfoFlags a, TimeInfoFlags b ) noexcept { return static_cast<TimeInfoFlags>( static_cast<std::underlying_type<TimeInfoFlags>::type>(a) & static_cast<std::underlying_type<TimeInfoFlags>::type>(b) ); }
constexpr inline TimeInfoFlags operator^ ( TimeInfoFlags a, TimeInfoFlags b ) noexcept { return static_cast<TimeInfoFlags>( static_cast<std::underlying_type<TimeInfoFlags>::type>(a) ^ static_cast<std::underlying_type<TimeInfoFlags>::type>(b) ); }
constexpr inline TimeInfoFlags operator~ ( TimeInfoFlags a ) noexcept { return static_cast<TimeInfoFlags>( ~static_cast<std::underlying_type<TimeInfoFlags>::type>(a) ); }
constexpr inline TimeInfoFlags & operator|= ( TimeInfoFlags & a, TimeInfoFlags b ) noexcept { return a = a | b; }
constexpr inline TimeInfoFlags & operator&= ( TimeInfoFlags & a, TimeInfoFlags b ) noexcept { return a = a & b; }
constexpr inline TimeInfoFlags & operator^= ( TimeInfoFlags & a, TimeInfoFlags b ) noexcept { return a = a ^ b; }
