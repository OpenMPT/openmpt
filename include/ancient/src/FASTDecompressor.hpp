...
{
public:
	FASTDecompressor(uint32_t hdr,uint32_t recursionLevel,const Buffer &packedData,std::unique_ptr<XPKDecompressor::State> &state,bool verify);
...
private:
	...
	static XPKDecompressor::Registry<FASTDecompressor> _XPKregistration;
};
