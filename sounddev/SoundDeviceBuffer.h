...
public:
	...
	inline void Read(Tbuffer & dst, std::size_t countChunk)
	{
		...
		SoundDevice::BufferRead(dst, m_src, m_countFramesReadProcessed, countChunk, m_bufferFormat.InputChannels, m_bufferFormat.sampleFormat);
	...
	inline void Write(Tbuffer & src, std::size_t countChunk)
	{
		...
		SoundDevice::BufferWrite(m_dst, m_countFramesWriteProcessed, src, countChunk, m_bufferFormat.Channels, m_dither, m_bufferFormat.sampleFormat, m_bufferFormat.NeedsClippedFloat);
