...
#define MPT_WIN_XP64     MPT_WIN_MAKE_VERSION(0x05, 0x02, 0x00, 0x00)
...
#define MPT_OS_WINDOWS_WIN32   0
#define MPT_OS_WINDOWS_VERISON (_WIN32_WINDOWS << 16)
#elif defined(WINVER)
#define MPT_OS_WINDOWS_WINNT   0
#define MPT_OS_WINDOWS_WIN9X   0
#define MPT_OS_WINDOWS_WIN32   1
#define MPT_OS_WINDOWS_VERISON (WINVER << 16)
#else
// assume modern
#define MPT_OS_WINDOWS_WINNT   1
#define MPT_OS_WINDOWS_WIN9X   0
#define MPT_OS_WINDOWS_WIN32   0
#define MPT_OS_WINDOWS_VERISON MPT_WIN_NT4
#endif
#if 0
#define MPT_WINRT_AT_LEAST(v) (MPT_OS_WINDOWS_WINRT && MPT_OS_WINDOWS_WINNT && (MPT_WIN_VERSION >= (v)))
#define MPT_WINRT_BEFORE(v)   ((MPT_OS_WINDOWS_WINRT && MPT_OS_WINDOWS_WINNT && (MPT_WIN_VERSION < (v))) || MPT_OS_WINDOWS_WIN9X || MPT_OS_WINDOWS_WIN32)
#define MPT_WINNT_AT_LEAST(v) (MPT_OS_WINDOWS_WINNT && (MPT_WIN_VERSION >= (v)))
#define MPT_WINNT_BEFORE(v)   ((MPT_OS_WINDOWS_WINNT && (MPT_WIN_VERSION < (v))) || MPT_OS_WINDOWS_WIN9X || MPT_OS_WINDOWS_WIN32)
#define MPT_WIN9X_AT_LEAST(v) ((MPT_OS_WINDOWS_WINNT || MPT_OS_WINDOWS_WIN9X) && (MPT_WIN_VERSION >= (v)))
#define MPT_WIN9X_BEFORE(v)   (((MPT_OS_WINDOWS_WINNT || MPT_OS_WINDOWS_WIN9X) && (MPT_WIN_VERSION < (v))) || MPT_OS_WINDOWS_WIN32)
